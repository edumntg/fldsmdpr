...
export const PROVIDER_META: ProviderMeta[] = [
  ...
  },
  {
    id: "slack",
    name: "Slack",
    tokenLabel: "Via Slack MCP server",
    placeholder: "",
    createUrl: "https://github.com/korotovsky/slack-mcp-server",
    createUrlLabel: "Slack MCP server (no app install)",
    steps: [
      "Slack connects through a local Slack MCP server — no Slack app to create.",
      "It authenticates with your existing session token (xoxc + xoxd cookie from your logged-in Slack) or a user token.",
      "The guided MCP setup (server + credentials + channel opt-in) ships in Phase 2.",
    ],
    scopes: ["channels:history (read-only)", "search:read"],
    available: false,
    unavailableNote: "MCP setup lands in Phase 2",
  },
  {
    id: "linear",
    name: "Linear",
